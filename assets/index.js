...
var processArticle,request,transformers;request=require("ld-request"),transformers=require("./transformers.coffee"),processArticle=function(t){var e,r;return t.html=null!=(e=t.html)?e.replace(/https\:\/\/app\.resrc\.it\/https\:\/\/livingdocs\-images\-dev\.s3\.amazonaws\.com\//g,"https://d3iceacr719ubs.cloudfront.net/images/bkXv1l4RQ/s:1600x1500/"):void 0,t.html=null!=(r=t.html)?r.replace(/http\:\/\/placehold\.it\/0x0/g,"http://suitart.gallery/default/100x100"):void 0,t},exports.getArticle=function(t,e){return request.get("http://staging.api.livingdocs.io/publications/public/"+t,function(t,r){return t?e(t):e(null,processArticle(r.publication))})},exports.getArticles=function(t){return request.get("http://staging.api.livingdocs.io/publications/public",function(e,r){return e?t(e):t(null,r.publications)})},exports.getTeasers=function(t){return exports.getArticles(function(e,r){return e?t(e):t(null,transformers.articlesToTeasers(r))})};
},{"./transformers.coffee":8,"ld-request":5}],8:[function(require,module,exports){
exports.constructImageUrl=function(e){var t,r,a;return"string"==typeof e&&(e={url:e}),r=((null!=e?e.url:void 0)||"").split("amazonaws.com/")[1],r?(a="s:1000x1000",(t=e.crop)&&(a+="-c:"+t.width+"x"+t.height+"x"+t.x+"x"+t.y),"http://suitart.gallery/images/bkXv1l4RQ/"+a+"/"+r):(null!=e?e.url:void 0)||e},exports.deduceTitleFromData=function(e){var t,r,a,n,l,o,i;for(a=0,l=e.length;l>a;a++)for(t=e[a],i=["hero","head","title"],n=0,o=i.length;o>n;n++)if(r=i[n],t.identifier==="timeline."+r&&null!=t.content.title)return t.content.title},exports.deduceTeaserImageFromData=function(e){var t,r,a,n,l,o,i;for(a=0,l=e.length;l>a;a++)for(t=e[a],i=["hero","fullsize","normal","peephole"],n=0,o=i.length;o>n;n++)if(r=i[n],t.identifier==="timeline."+r&&null!=t.content.image)return t.content.image},exports.articlesToTeasers=function(e){var t,r,a,n,l,o;for(o=[],r=0,a=e.length;a>r;r++)t=e[r],o.push({title:(null!=(n=t.metadata)?n.title:void 0)||exports.deduceTitleFromData(t.data.content),teaserImage:exports.constructImageUrl((null!=(l=t.metadata)?l.teaser_image:void 0)||exports.deduceTeaserImageFromData(t.data.content)),articleId:t.slug||t.document_id});return o};
},{}]},{},[1]);
