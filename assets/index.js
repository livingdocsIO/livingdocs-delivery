...
exports.constructImageUrl=function(e){var t,r,n;return"string"==typeof e&&(e={url:e}),r=((null!=e?e.url:void 0)||"").split("amazonaws.com/")[1],r?(n="",(t=e.crop)&&(n+="c:"+t.x+"x"+t.y+"x"+t.width+"x"+t.height+"-"),n+="t:jpg-progressive","http://imgr.io/livingdocs/"+n+"/"+r):(null!=e?e.url:void 0)||e.originalUrl},exports.deduceTitleFromData=function(e){var t,r,n,o,i,a,l;for(n=0,i=e.length;i>n;n++)for(t=e[n],l=["hero","head","title"],o=0,a=l.length;a>o;o++)if(r=l[o],t.identifier==="timeline."+r&&null!=t.content.title)return t.content.title},exports.deduceTeaserImageFromData=function(e){var t,r,n,o,i,a,l;for(n=0,i=e.length;i>n;n++)for(t=e[n],l=["hero","fullsize","normal","peephole"],o=0,a=l.length;a>o;o++)if(r=l[o],t.identifier==="timeline."+r&&null!=t.content.image)return t.content.image},exports.articlesToTeasers=function(e){var t,r,n,o,i,a;for(a=[],r=0,n=e.length;n>r;r++)t=e[r],a.push({title:(null!=(o=t.metadata)?o.title:void 0)||exports.deduceTitleFromData(t.data.content),teaserImage:exports.constructImageUrl((null!=(i=t.metadata)?i.teaser_image:void 0)||exports.deduceTeaserImageFromData(t.data.content)),articleId:t.slug||t.document_id});return a};
},{}]},{},[1]);
